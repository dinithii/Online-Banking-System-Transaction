...
<title>Transaction History Check</title>
</head>
<body>
...
window.onclick = function(e) {
  ...
  var myDropdown = document.getElementById("myDropdown");
    ...
    <div class="dtransH1">
        <form name="tHistoryCheck" action="deleteTForm" method="POST">

            <div class="f1">
            	 <label class="lb1" for="sNum">Transaction Receipt Number</label><br>
