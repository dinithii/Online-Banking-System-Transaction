...
<body>
	<div class="successtrns">
		...
		<div class="dtransH1">
			<h1 class=sh1>Your Receipt Deletion Has Been Successful</h1>
			<img src="images/deleteBin.png" alt="bin" width="110" height="110" />
			
			<button class="sb5"><a href="http://localhost:8082/Transaction/loginTHistory.jsp">Go to my transaction receipts page</a></button>
