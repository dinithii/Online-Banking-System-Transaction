...
<head>
	...
	<title>Domestic Transactions</title>
...
<body>
	<div class="successtrns">
		...
		<div class="dtransH1">
			<h1 class=sh1>Domestic Transaction has been successful</h1>
			<img src="images/success2.png" alt="tick" width="110" height="110" />
			
			<button class="sb5"><a href="http://localhost:8082/Transaction/loginTHistory.jsp">Get My Domestic transaction Receipt</a></button>
			<button class="sb1"><a href="homepage.jsp">Back To Home Page</a></button>
		</div>
